...
void covid_management::menu()
{
    ...
    case 3:
        system("cls");
        cout << "\n\n\t\t\t ****************** COVID19 MANAGEMENT SYSTEM - FINAL YEAR PROJECT *****************";
        cout << "\n\n\t\t\t ------------------------------------------------------------------------------------";
        Sleep(10);
        exit(0);
    default:
...
void covid_management::admin_password()
{
    ...
    cout << "\n\n\t\tEnter Valid Captcha: ";
    cin >> capta;
    if ((strcmp(a_name,"sushmita") == 0) && (strcmp(a_password, "1234") == 0) && (capt == capta))
    {
        cout << "\n\n\n\t\t\t\t\t| Verfiying ADMIN |\n\t\t\t\t\t";
        for (int a = 1; a < 8; a++)
        {
...
void covid_management::display_vaccine_stock()
{
    ...
    ind.open("Patient_Data.txt"); // Data take from Patient file
    ind.seekg(0, ios::beg);
    ...
    ind.close();
    int s = 0;
    s+=TOTAL_VACCINE + sum_vaccine_c1 + sum_vaccine_c2 + sum_vaccine_c3 - i;
    file1.close();
    file2.close();
    file3.close();
...
B:
    ...
    cout << "\n\n\t\tEnter Age: ";
    cin >> age;
    cout << "\n\n\t\tEnter Specialization(at max 40 alphabets): ";
    fflush(stdin);
...
void covid_management::doctor_show_data()
{
    ...
    cout.setf(ios::left, ios::adjustfield);
    cout.width(25);
    cout << setfill(' ') << this->identification_id;
    cout.setf(ios::left, ios::adjustfield);
    cout.width(25);
    cout << endl
         << "Aadhar No.: ";
    ...
    cout.setf(ios::left, ios::adjustfield);
    cout.width(25);
    cout << setfill(' ') << this->specialization;
    cout.setf(ios::left, ios::adjustfield);
    cout.width(25);
    cout << endl
         << "Center Allotted: ";
